...
package pe
{
	...
	public class PelletManager
	{
		...
		// ----------------------------------------------------------------------
		public function createRigidBody( obj:Node3D, mass:Number, shape:btCollisionShape ):btRigidBody
		{
		...
		/*public function createRegularTetrahedron( radius:Number, material:MaterialBase = undefined, name:String = undefined, id:String = undefined ):Node3D
		{
		...
		public function createBox( 
			...
			drawAble:DrawAble3D=null,
			name:String = undefined, 
			id:String = undefined ):Node3D
		{
			var obj:Node3D = new Node3D;//MeshUtils.createBox( sizeX, sizeY, sizeZ, material, name, id );
		...
		{
			var obj:Node3D = new Node3D;//MeshUtils.createPlane( sizeX, sizeZ, uTess, vTess, material, name, id, uScale, vScale, uOffset, vOffset );
			obj.drawAble = drawAble;
			obj.set_material(material);
