...
//{
	...
	import lz.native3d.materials.NmeTestMaterial;
	 ...
	 class TwoDExample extends Sprite
	{
		
		public static function main() {
			Lib.current.addChild( new TwoDExample());
		}
		...
		{
			//drawAble = MeshUtils.createCube(5);
			//drawAble = MeshUtils.createTeaPot();
			drawAble = MeshUtils.createPlane(10,bv.instance3Ds[0]);
